...
Finalement, nous avons tenté de trouver un évènement qui n'avait pas de bonnes caractéristiques. Nous avons examiné les évènements qui avaient des valeurs extrêmes (i.e., distance important par rapport au filet; >90pieds) et nous avons visionné les vidéos associées à ces évènements. Parmi les vidéos qui étaient disponibles, nous n'avons pas trouvé d'évènements qui semblaient avoir de mauvaise coordonnée. Par contre, notre recherche a été limité à un faible nombre de vidéos et il se peut que nous avons manqué un évènement ayant de mauvais valeurs pour ces caractéristiques.
...
[Lien expérience pour le modèle régression logistique avec la distance uniquement](https://www.comet.com/me-pic/milestone-2/b3f46f9da6f042169bc00b9329e23787)
[Lien expérience pour le modèle régression logistique avec l'angle uniquement](https://www.comet.com/me-pic/milestone-2/899e8bfc5d754c27b1d13392cd4a2dda)
[Lien expérience pour le modèle régression logistique avec la distance et l'angle](https://www.comet.com/me-pic/milestone-2/85685c9c8653405a8c8893b78b43c372)
...
NB: La variable `is_goal` est la variable que l'on tente de prédire. Elle a été séparée du reste des caractéristique pour l'entraînement des modèles.
...
Pour la validation-croisée, un Kfold avec k=5 a été effectué, ce qui signifie que 135 (3x3x3x5) combinaisons possibles d'hyperparamètres ont été testées. Les scores ROC selon les valeurs d'hyperparamètres peuvent être observé ci-dessous:

<p align="center">
      <img src="../assets/images/milestone2/n_estimators_XGBoost.png" align="left" width="560" height="425">
      <img src="../assets/images/milestone2/max_depth_XGBoost.png" width="560" height="425">
</p>
<img src="../assets/images/milestone2/learning_rate_XGBoost.png" width="560" height="425">

Les graphiques produits mettent en évidence que, au fil des entraînements, les performances les plus optimales se manifestent en effet lorsque les hyperparamètres trouvé grâce à la recherche par grille sont utilisés. Ceci est clairement observable dans les graphiques, où ces paramètres se traduisent par le score ROC AUC le plus élevé, se retrouvant au sommet de la courbe. La meilleure solution a été trouvée avec les valeurs suivantes:
- `n_estimators` = 200
- `max_depth` = 5
- `learning_rate` = 0.1
...
On voit que les résultats du modèle avancé, le XGBoost est déjà beaucoup meilleur que le resultat des modèles de régressions. Ceux-ci avaient des ROC Score d’au meilleur proche de 0.70, alors que les résultats du modèle XGBoost se rapproche de 0.794, ce qui est une amélioration de plus de 13% des résultats. Il est donc très important de visiter d’autres modèles lorsque l’on fait de la science de données.
...
**Régression Logistique améliorée (Boosted Logistic Regression)**
...
<img src="../assets/images/milestone2/roc_df.png" width="550" height="425">
<img src="../assets/images/milestone2/roc_histbg.png" width="560" height="425">
<img src="../assets/images/milestone2/roc.png" width="550" height="425">

Les modèles testés ont tous été entraînés sur les mêmes caractéristiques, soit les caractéristiques énumérées dans la section *Ingénierie des caractéristiques II*. Les trois modèles ont donné des performances comparables au meilleur modèle XGBoost présenté dans la section *Modèles avancés*. Le modèle de régression logistique améliorée (*Boosted Logistic Regression*) a donné de meilleures performances que la forêt aléatoire et le classificateur *Histogram-based Gradient Boost*, avec un score ROC de XX comparativement à XX et XX pour les autres modèles, respectivement.
...
Pour le test sur la saison régulière, les deux modèles *XGboost* et *Boosted_Logistic_regression* ont presque gardé les mêmes performances en termes de séparation entre nos deux classes d’après les courbes ROC (respectivement un score AUC de 0.76 et 0.77), tandis qu'en termes de calibration la courbe de *XGboost* est au-dessous la courbe idéale ce qui signifie qu’il sous-estime les probabilité au-delà de 0.2, contrairement au modèle *Boosted_Logitic_regression* qui a montré une courbe plus calibrée. Les modèles de la régression logistique de base sont devenus moins performant et leur score est similaires à un classifieur qui classifie au hasard (échantillons aléatoire) vu qu’ils sont entrainés sur deux caractéristique seulement.

### Question 2

<p align="center">
      <img src="../assets/images/milestone2/ROC_curve_final_models_playoff.png" align="left" width="550" 
height="425">
      <img src="../assets/images/milestone2/Centiles_plot_final_models_playoff.png" width="560" height="425">
</p>
<p align="center">
      <img src="../assets/images/milestone2/cumulative_centiles_plot_final_models_playoff.png" align="left" width="550" 
height="425">
      <img src="../assets/images/milestone2/calibrate_display_final_models_playoff.png" width="550" height="425">
</p>

Dans le cas de la saison éliminatoire, on remarque que les modèles ont gardé des performances comparables au niveau des scores AUC mais perdent de la stabilité. En effet, les courbes de calibration oscillent autour de la ligne idéale, ce qui signifie que la capacité de généralisation de nos modèles est surpassée par l'irrégularité des données de la saison éliminatoire et que ce n’est pas très similaire aux données des saison régulières.