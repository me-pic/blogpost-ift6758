...
<img src="../assets/images/visu/density_2016.png">
<img src="../assets/images/visu/density_2017.png">
<img src="../assets/images/visu/density_2018.png">
<img src="../assets/images/visu/density_2019.png">
<img src="../assets/images/visu/density_2020.png">

### Question 2

*Pour interpréter les graphiques, il faut s'imaginer que le filet est vers le bas de la figure.*

En regardant les graphiques du taux de tirs par emplacement, il est possible de voir qu'en moyenne les tirs sont surtout effectués à partir du milieu de la glace et surtout lorsque les joueurs sont dans une zone rapprochée du filet. Lorsque l'on s'éloigne du filet, les tires proviennent en moyenne un peu plus des côtés. Ces observations montrent qu'il pourrait être pertinent de considérer la distance par rapport au filet, ainsi que l'angle entre le tir et le filet pour prédire si un joueur a réussi à marquer ou non. Il serait intéressant de reproduire cet exercice mais en séparant les buts des tirs manqués. En effet, cela nous fournirait potentiellement une meilleure intuition quant l'impact du positionnement par rapport au filet sur la probabilité de marquer un but.

### Question 3

*Pour interpréter les graphiques, il faut s'imaginer que 
le filet est vers le bas de la figure.*
...
Les graphiques suggèrent que lors des deux saisons, l'avanche a effectué en moyenne moins de tire que la moyenne de la ligue sur presque toute la zone de but. Par contre, en 2020-2021, il semblerait qu'il y a eu plus de tirs près du filet comparativement à la saison 2016-2017 (bleu plus pâle). Cette observation pourrait potentiellement expliquer l'amélioration de cette équipe à la saison 2020-2021 comparativement à la saison 2016-2017. Cependant, d'autres facteurs restent à explorer et à ce point, nous ne pouvons générer de forte conclusion.

<img src="../assets/images/visu/avalanche_2016_2017.png">
<img src="../assets/images/visu/avalanche_2020_2021.png">
